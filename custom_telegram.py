...
class TelegramInput(InputChannel):
    ...
    @staticmethod
    def _is_photo(message: Update) -> bool:
        return message.photo is not None
    @staticmethod
    def _is_document(message: Update) -> bool:
    ...
    def blueprint(
        ...
        async def message(request: Request) -> Any:
            if request.method == "POST":
                ...
                if self._is_button(update):
                    ...
                    if self._is_user_message(msg):
                        ...
                        logger.info(msg.photo[2].file_id)
                        text = msg.photo[2].file_id #msg.photo
                    elif self._is_document(msg):
            ...
            if request.method == "GET":
                print("get requested",request.json)
